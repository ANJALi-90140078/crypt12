...
const CoinChart = ({currency}) => {
  ...
  <div className='btns' style={{marginTop:"30px", padding:"30px"}}>
               <button onClick={()=>setDays(1)} >24 hours</button>
               <button onClick={()=>setDays(30)}>1 Month</button>
               <button onClick={()=>setDays(365)}>1 Year</button>

    <div className='btnss' style={{marginTop:"30px", padding:"30px"}}>
               <button onClick={()=>setDays(20)} >BUY</button>
               <button onClick={()=>setDays(90)}>SELL</button>            
       </div>
  </div>
  </div>
      )
